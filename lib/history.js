...
function getAllHistory (callback) {
  console.group("getAllHistory")
  console.time("getAllHistory")
  console.time("DB")
//  models.Note.findAll({"attributes": {"exclude": ["content"] }})
  models.Note.findAll()
    .then(function (notes) {
      console.timeEnd("DB")
      ...
      console.timeEnd("returnVal")
      console.timeEnd("processing")
//      logger.info(`read history success: ${out}`)
      console.timeEnd("getAllHistory")
      console.groupEnd("getAllHistory")
